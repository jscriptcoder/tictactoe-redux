...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var tictactoegame_1 = __webpack_require__(20);
	var actions_1 = __webpack_require__(21);
	var initialState = new tictactoegame_1.TicTacToeGame();
	exports.board = function (state, action) {
	    if (state === void 0) { state = initialState.board; }
	    switch (action.type) {
	        case actions_1.ACTIONS.ADD_SYMBOL:
	...
	exports.turn = function (state, action) {
	    if (state === void 0) { state = initialState.turn; }
	    switch (action.type) {
	        case actions_1.ACTIONS.CHANGE_TURN:
	            if (state === tictactoegame_1.SYMBOL.X) {
	                return tictactoegame_1.SYMBOL.O;
	            }
	            else {
	                return tictactoegame_1.SYMBOL.X;
	            }
	        default:
	            return state;
	    }
	    ...
	    switch (action.type) {
	        case actions_1.ACTIONS.NEW_MOVE:
	            if (state.canPlay(action.i, action.j)) {
	                var newState = new tictactoegame_1.TicTacToeGame();
	                newState.board = exports.board(state.board, actions_1.addSymbol(action.i, action.j, state.turn));
	                newState.turn = state.turn;
	                if (newState.isLine(action.i, action.j)) {
	                    newState.winner = state.turn;
	                }
	                else {
	                    newState.turn = exports.turn(state.turn, actions_1.changeTurn());
	                }
	                return newState;
	            }
	        default:
...
/***/ function(module, exports) {
	...
	exports.symbol2String = function (symbol) {
	    switch (symbol) {
	...
	exports.string2Symbol = function (symbol) {
	...
	var TicTacToeGame = (function () {
	    ...
	    TicTacToeGame.prototype.toString = function () {
	        ...
	        for (var i = 0; i < size; i++) {
	            ...
	            for (var j = 0; j < size; j++) {
	                strGame += "| " + exports.symbol2String(this.board[i][j]) + " ";
	            }
	            strGame += '|\n|   |   |   |\n';
	            strGame += '+---+---+---+\n';
	        }
	        if (this.isWinner()) {
	            strGame += "Winner: " + exports.symbol2String(this.winner);
	        }
	        else {
	            strGame += "Turn: " + exports.symbol2String(this.turn);
	        }
	        return strGame;
	    };
	    ...
	    TicTacToeGame.prototype.isCellEmpty = function (i, j) {
...
/***/ function(module, exports) {
	...
	(function (ACTIONS) {
	    ...
	    ACTIONS[ACTIONS["ADD_SYMBOL"] = 1] = "ADD_SYMBOL";
	...
	exports.addSymbol = function (i, j, symbol) {
	    return { type: ACTIONS.ADD_SYMBOL, i: i, j: j, symbol: symbol };
	};
