...
/***/ function(module, exports, __webpack_require__) {
	...
	store.dispatch(actions_1.newMove(0, 1));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tictactoegame_1 = __webpack_require__(21);
	var actions_1 = __webpack_require__(22);
	    ...
	    TicTacToeGame.prototype.toString = function () {
	        ...
	        for (var i = 0; i < size; i++) {
	            ...
	            for (var j = 0; j < size; j++) {
	                game += "| " + exports.symbol2String(this.board[i][j]) + " ";
	            }
	            game += '|\n|   |   |   |\n';
	            game += '+---+---+---+\n';
	        }
	        if (this.isWinner()) {
	            game += "Winnerasfdsaf: " + exports.symbol2String(this.winner);
	        }
	        else {
	            game += "Turn: " + exports.symbol2String(this.turn);
	        }
	        return game;
	    };
